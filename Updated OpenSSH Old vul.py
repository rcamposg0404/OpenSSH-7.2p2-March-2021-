...
def connect(host, port, user):
  ...
  try:
    ssh.connect(hostname = host, port = 2222, username = user, password = p, look_for_keys = False, gss_auth = False, gss_kex = False, gss_deleg_creds = False, gss_host = None, allow_agent = False)
  except:
